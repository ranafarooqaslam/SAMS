...
class OrderDetailAdapter(var data: ArrayList<OrderItem>, val clickListener: DeleteClickListener) : RecyclerView.Adapter<OrderRowVH>() {
...
class OrderRowVH(view: View, clicklistner: DeleteClickListener) : RecyclerView.ViewHolder(view), View.OnClickListener {
