...
//                      }
                        ...
                        if (responseInsertOrder.Satus?.equals("OK") == true) {
                            ...
                            SamsApplication.getDB().orderDetailFreeSkusDao()
                                .delete(orderDetailsFreeSkU)
                    ...
                    val stockPositionMaster =
                        SamsApplication.getDB().stockPositioningMasterDao().getAllNonSync()
    ...
    private suspend fun updateToken(): GoogleAuth? {
        val auth = googleService?.refeshToken(
