...
interface OrderMasterDao {
    ...
    @Query("SELECT OM.SOLD_TO AS OUTLET_CODE, O.outletName AS OUTLET_NAME, OM.TOTAL_NET_AMOUNT AS NET_AMOUNT FROM ORDER_MASTER OM INNER JOIN OUTLET O ON OM.SOLD_TO = O.outletID")
