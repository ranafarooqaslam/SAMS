...
//            (activity as? BaseActivity)?.replaceFragment(DashboardFragment.newInstance(), false)
    ...
    private fun populateChannel() {
        ...
        val adapterChannel = ArrayAdapter<Channel>(context, android.R.layout.simple_spinner_item, viewModel.channels)
    ...
    private fun populateSections() {
        val adapterSections = ArrayAdapter<Section>(context, android.R.layout.simple_spinner_item, viewModel.sections)
    ...
    fun populateSubChannels() {
        val adapterSubChannel = ArrayAdapter<SubChannel>(context, android.R.layout.simple_spinner_item, viewModel.subChannels.filter { it.parentID == viewModel.outlet.ChannelID })
