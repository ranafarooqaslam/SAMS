...
interface OrderDetailDao {
    ...
    @Query("SELECT S.SKU_NAME,SUM(OD.QUANTITY_UNIT) AS QUANTITY_UNIT ,SUM(OD.NET_AMOUNT) AS NET_AMOUNT,OD.UNITS_IN_CASE AS QUANTITY_CTN  FROM ORDER_DETAIL OD INNER JOIN SKU S ON S.SKU_ID = OD.SKU_ID GROUP BY OD.SKU_ID")
